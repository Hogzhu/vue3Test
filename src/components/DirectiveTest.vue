...
<template>
  ...
  <div v-change-color="{ colorText: 'red' }" @click="updateDiv">
    {{ divText.value }}
  </div>
...
export default {
  ...
  setup() {
    ...
    let imgSrc = reactive({
      value:
        "https://dss1.bdstatic.com/6OF1bjeh1BF3odCf/it/u=3791572139,3337857573&fm=218&app=2&f=PNG?w=121&h=75&s=A1D1A366FBE5976C4E6DF40F0300F0C2"
    });
